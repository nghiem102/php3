                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if($item->trang_thai == 1)
                                        <a href="{{route('route_BackEnd_Khachhang_Delete',$item->id)}}" onclick="return confirm('Bạn có chắc muốn xóa')">Xóa /</a>
                                    @endif
                                    <a href="{{ route('route_BackEnd_Khachhang_Detail',$item->id) }}">Sửa</a>
                                </td>
                            </tr>
                            @endforeach
                    </table>
