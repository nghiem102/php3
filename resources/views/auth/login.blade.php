    ...
    <div class="login-box-body">
        <form action="{{ url('/login') }}" method="post">
            <div class="form-group has-feedback">
                <input style="padding-left: 10px;" type="text" name="email" class="form-control" placeholder="Nhập email">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input style="padding-left: 10px;" type="password" name="password" class="form-control" placeholder="Nhập mật khẩu">
            ...
            <!-- /.col -->
                <div class="col-xs-12">
                    <button type="submit" class="btn btn-block btn-flat text-center btn-login">Đăng nhập</button>
                </div>
